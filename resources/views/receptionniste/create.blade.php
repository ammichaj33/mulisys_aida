...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('receptionniste.loans.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('receptionniste.dashboard') }}" class="btn btn-outline-secondary me-2">
