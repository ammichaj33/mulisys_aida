...
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('gerant.repayments.index') }}" class="row g-3">
                    <div class="col-md-8">
...
@if ($loans->isEmpty())
    <div class="text-center py-5">
        @if(request('search'))
            ...
            <a href="{{ route('gerant.repayments.index') }}" class="btn btn-outline-primary">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="alert alert-info">
                    ...
                    <a href="{{ route('gerant.repayments.index') }}" class="btn btn-sm btn-outline-secondary ms-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            @if($repayments->count() > 0)
                                <a href="{{ route('gerant.loans.show', $loan->loanDocId) }}#repayments" 
                                   class="btn btn-info me-2">
                                    <i class="fas fa-list me-1"></i>Voir remboursements ({{ $repayments->count() }})
                                </a>
                            @endif
                        </div>
                    </div>
