...
@section('title', 'Validation finale des crédits')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-gavel me-2"></i>Validation finale des crédits</h2>
...
<div class="row mb-4">
    <div class="col-12">
        <div class="alert alert-info">
            ...
            <strong>Validation finale :</strong> Examinez et approuvez ou rejetez les demandes de crédit acceptées par le chargé des crédits.
        </div>
    </div>
</div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('gerant.final-validation') }}" class="final-validation-form">
                            @csrf
                            <input type="hidden" name="loanDocId" value="{{ $loan->loanDocId }}">
                            
                            <div class="mb-3">
                                <label for="comments_{{ $loan->loanDocId }}" class="form-label">
                                    Commentaires <span class="text-danger">*</span>
                                </label>
                                <textarea class="form-control" id="comments_{{ $loan->loanDocId }}" 
                                          name="comments" rows="2" placeholder="Commentaires sur la décision finale..." required></textarea>
                                <div class="form-text text-muted">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Ce champ est obligatoire pour justifier votre décision.
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" name="decision" value="validated" 
                                        class="btn btn-success" onclick="return confirm('Êtes-vous sûr de valider cette demande ?')">
...
document.querySelectorAll('.final-validation-form').forEach(form => {
    form.addEventListener('submit', function(e) {
        const decision = e.submitter.value;
        
        if (decision === 'validated') {
            if (!confirm('Êtes-vous sûr de valider définitivement cette demande de crédit ?')) {
                e.preventDefault();
            }
