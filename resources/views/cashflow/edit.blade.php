    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2><i class="fas fa-edit me-2"></i>Modifier la transaction</h2>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cashflow.update', $transaction->cashflowTransactionId) }}" id="transactionForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('transactionDate') is-invalid @enderror" 
                                       ...
                                       value="{{ old('transactionDate', $transaction->transactionDate->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('transactionType') is-invalid @enderror" 
                                    ...
                                    <option value="income" {{ old('transactionType', $transaction->transactionType) == 'income' ? 'selected' : '' }}>Entrée</option>
                                    <option value="expense" {{ old('transactionType', $transaction->transactionType) == 'expense' ? 'selected' : '' }}>Sortie</option>
                                </select>
                                ...
                                <select class="form-select @error('categoryIdFk') is-invalid @enderror" 
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->categoryId }}" 
                                                ...
                                                {{ old('categoryIdFk', $transaction->categoryIdFk) == $category->categoryId ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('accountIdFk') is-invalid @enderror" 
                                    ...
                                    @foreach($accounts as $account)
                                        <option value="{{ $account->accountId }}" {{ old('accountIdFk', $transaction->accountIdFk) == $account->accountId ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('paymentMethod') is-invalid @enderror" 
                                    ...
                                    <option value="cash" {{ old('paymentMethod', $transaction->paymentMethod) == 'cash' ? 'selected' : '' }}>Espèces</option>
                                    <option value="bank" {{ old('paymentMethod', $transaction->paymentMethod) == 'bank' ? 'selected' : '' }}>Banque</option>
                                    <option value="mobile_money" {{ old('paymentMethod', $transaction->paymentMethod) == 'mobile_money' ? 'selected' : '' }}>Mobile Money</option>
                                    <option value="check" {{ old('paymentMethod', $transaction->paymentMethod) == 'check' ? 'selected' : '' }}>Chèque</option>
                                </select>
                                @error('paymentMethod')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('referenceNumber') is-invalid @enderror" 
                                       ...
                                       value="{{ old('referenceNumber', $transaction->referenceNumber) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="confirmed" {{ old('status', $transaction->status) == 'confirmed' ? 'selected' : '' }}>Confirmé</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('loanDocIdFk') is-invalid @enderror" 
                                    ...
                                    @foreach($loans as $loan)
                                        <option value="{{ $loan->loanDocId }}" {{ old('loanDocIdFk', $transaction->loanDocIdFk) == $loan->loanDocId ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('memberIdFk') is-invalid @enderror" 
                                    ...
                                    @foreach($members as $member)
                                        <option value="{{ $member->memberId }}" {{ old('memberIdFk', $transaction->memberIdFk) == $member->memberId ? 'selected' : '' }}>
