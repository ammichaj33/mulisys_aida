...
@section('title', 'Rapport des crédits octroyés par périodes')

@section('content')
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="fas fa-file-alt me-2"></i>Rapport des crédits octroyés par périodes</h2>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('reports.credits-octroyes') }}" class="row g-3">
                        <div class="col-md-4">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="d-flex justify-content-end">
                <a href="{{ route('reports.credits-octroyes', array_merge(request()->all(), ['pdf' => 1])) }}" 
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center">Aucun crédit trouvé pour cette période</td>
                                </tr>
                                @endforelse
                            </tbody>
