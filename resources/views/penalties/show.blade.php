            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td><span class="text-danger fw-bold h5">{{ round($penalty->amount, 2) }} USD</span></td>
                            </tr>
                            <tr>
                ...
                @if($penalty->description)
                    <div class="mt-3">
                        ...
                        <p class="mt-2 p-3 bg-light rounded">{{ $penalty->description }}</p>
                    </div>
                @endif
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            <li><strong>Taux mensuel :</strong> {{ config('penalties.penalty_monthly_rate', 1.0) }}% par mois</li>
                            <li><strong>Jours de tolérance :</strong> {{ config('penalties.tolerance_days', 5) }} jours</li>
                        ...
                        @if($penaltyDetails)
                            ...
                            <div class="bg-light p-3 rounded">
                                ...
                                <ul class="mb-2">
                                    ...
                                    <li>Montant attendu : <strong>{{ round($penaltyDetails['expected_amount'], 2) }} USD</strong></li>
                                    <li>Montant remboursé avant échéance : <strong>{{ round($penaltyDetails['total_repaid_before_due'], 2) }} USD</strong></li>
                                    <li>Capital restant dû : <strong>{{ round($penaltyDetails['remaining_capital'], 2) }} USD</strong></li>
                                    <li>Mois de retard : <strong>{{ $penaltyDetails['months_overdue'] }} mois</strong></li>
                                    <li>Taux mensuel : <strong>{{ $penaltyDetails['monthly_rate'] }}%</strong></li>
                                </ul>
                                <p><strong>Calcul :</strong></p>
                                <p class="mb-0">
                                    <code>Pénalité = {{ round($penaltyDetails['remaining_capital'], 2) }} × {{ $penaltyDetails['monthly_rate'] }}% × {{ $penaltyDetails['months_overdue'] }} = {{ round($penaltyDetails['calculated_penalty'], 2) }} USD</code>
                                </p>
                            </div>
                        @else
