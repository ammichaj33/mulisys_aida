...
@section('title', 'Nouveau remboursement')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-plus-circle me-2"></i>Nouveau remboursement</h2>
                ...
                <form method="POST" action="{{ route('repayments.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" 
                                  placeholder="Description du remboursement...">{{ old('description') }}</textarea>
                    </div>
                    
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('repayments.index') }}" class="btn btn-secondary me-md-2">Annuler</a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning">
                    ...
                    <p class="mb-0">Vérifiez que le montant et la date sont corrects avant d'enregistrer.</p>
                </div>
            </div>
        </div>
    </div>
