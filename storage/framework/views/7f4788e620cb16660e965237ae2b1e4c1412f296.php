...
<?php $__env->startSection('title', 'Demandes de crédit - Réceptionniste'); ?>
...
<div class="row mb-4">
    <div class="col-md-2 mb-3">
        <a href="<?php echo e(route('receptionniste.loans.index', ['status' => 'draft'])); ?>" class="text-decoration-none">
    ...
    <div class="col-md-2 mb-3">
        <a href="<?php echo e(route('receptionniste.loans.index', ['status' => 'accepted'])); ?>" class="text-decoration-none">
    ...
    <div class="col-md-2 mb-3">
        <a href="<?php echo e(route('receptionniste.loans.index', ['status' => 'validated'])); ?>" class="text-decoration-none">
    ...
    <div class="col-md-2 mb-3">
        <a href="<?php echo e(route('receptionniste.loans.index', ['status' => 'rejected'])); ?>" class="text-decoration-none">
    ...
    <div class="col-md-2 mb-3">
        <a href="<?php echo e(route('receptionniste.loans.index', ['status' => 'done'])); ?>" class="text-decoration-none">
    ...
    <div class="col-md-2 mb-3">
        <a href="<?php echo e(route('receptionniste.loans.index')); ?>" class="text-decoration-none">
            <div class="card stats-card <?php if(!request('status')): ?> border-secondary <?php endif; ?>">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-0"><?php echo e($loans->total()); ?></h3>
                ...
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            ...
                            <option value="done" <?php echo e((request('status') == 'done') ? 'selected' : ''); ?>>Terminé</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('receptionniste.loans.index')); ?>" class="btn btn-outline-secondary">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    <?php if($loans->count() > 0): ?>
                        <span class="badge bg-primary ms-2"><?php echo e($loans->count()); ?> résultat(s)</span>
                    <?php endif; ?>
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <strong><?php echo e($loan->refNumber); ?></strong>
                                        </td>
                                        <td>
                                            <?php echo e($loan->member->firstName); ?> <?php echo e($loan->member->lastName); ?>

                                            <br>
                                            <small class="text-muted"><?php echo e($loan->member->phoneNumber); ?></small>
                                        </td>
                                        <td><?php echo e(number_format($loan->requestAmount, 2, ',', ' ')); ?> USD</td>
                                        <td><?php echo e($loan->loanMonths); ?> mois</td>
                                        <td>
                                            <?php
                                                $statusLabels = [
                                                    'draft' => 'Brouillon',
                                        ...
                                        <td><?php echo e(date('d/m/Y', strtotime($loan->createdAt))); ?></td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('receptionniste.loans.show', $loan->loanDocId)); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mulisys_aida\resources\views/receptionniste/index.blade.php ENDPATH**/ ?>