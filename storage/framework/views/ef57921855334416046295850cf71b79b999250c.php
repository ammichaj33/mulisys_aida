...
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('caissiere.repayments.index')); ?>" class="row g-3">
                    <div class="col-md-8">
...
<?php if($loans->isEmpty()): ?>
    <div class="text-center py-5">
        <?php if(request('search')): ?>
            ...
            <a href="<?php echo e(route('caissiere.repayments.index')); ?>" class="btn btn-outline-primary">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="alert alert-info">
                    ...
                    <a href="<?php echo e(route('caissiere.repayments.index')); ?>" class="btn btn-sm btn-outline-secondary ms-2">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo e(route('caissiere.loans.show', $loan->loanDocId)); ?>" 
                               class="btn btn-outline-primary me-2">
                                <i class="fas fa-eye me-1"></i>Voir détails
                            </a>
                            <?php if($loan->remainingAmount > 0): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mulisys_aida\resources\views/caissiere/repayments/index.blade.php ENDPATH**/ ?>